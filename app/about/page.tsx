...
export default function About() {
  return (
    <section>
      ...
      <p className="mb-4">
        I taught myself to code in 2014 and have been working as a professional
        software engineer since 2016. I created SolutionOps LLC to operate
        independently since I frankly had no idea what I was doing and felt
        completely in over my head when I applied for my first real position as
        a software engineer.
      </p>
      <p className="mb-4">
        ...
        since, and have been promoted to engineering manager. I pride myself on
        my leadership skills and ability to mentor junior engineers and create
        psychologically safe environments for my team to excel both
      ...
      <p className="mb-4">
        ...
        considerable time into my health and physical fitness, training six days
        a week to compete in powerlifting and reach my highest potential. But I
        am getting old and tired, so maybe I will settle for just being healthy
        and strong :)
      </p>
    </section>
  );
