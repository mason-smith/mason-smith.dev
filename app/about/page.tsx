...
export default function About() {
  return (
    <section>
      ...
      <p className="mb-4">
        I taught myself to code in 2014 and have been working as a professional software engineer since 2016. I created
        SolutionOps LLC to operate independently since I frankly had no idea what I was doing and felt completely in
        over my head when I applied for my first real position as a software engineer.
      </p>
      <p className="mb-4">
        In 2018, I had burned myself out as an independent contractor and was looking for a change. I moved around the
        country a bit and eventually landed in Colorado where I was hired as a senior engineer at BackbonePLM. They were
        acquired by Bamboo Rose in March 2023. I have been working nomadically between Seattle, WA and Louisville, KY
        ever since, and have been promoted to engineering manager. I pride myself on my leadership skills and ability to
        mentor junior engineers and create psychologically safe environments for my team to excel both professionally
        and interpersonally.
      </p>
      <p className="mb-4">
