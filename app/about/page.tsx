    ...
    <main className="p-4 lg:container lg:mx-auto">
      ...
      <section>
        ...
        <p className="mt-4">
          ...
          Louisville, KY ever since, and have been promoted to engineering manager. I pride myself on my leadership
          skills and ability to mentor junior engineers and create psychologically safe environments for my team to
