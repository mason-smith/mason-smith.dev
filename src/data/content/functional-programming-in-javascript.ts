export const content = `## What is functional programming?
...
This is key to understanding functional programming and higher order functions, because as we will see as time goes on, we will need these higher order functions to
...
A possible drawback of this method is that if we make a copy of every array, particularly with large arrays, we can introduce memory and performance inefficiencies
in our project.
...
has changed the way I write, structure, and think about code. Predictability is my new best friend, and my software is all the better for it.
